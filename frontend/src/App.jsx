...
const MyCounter=()=>{
  ...
  const MyfetchCounter=useCallback(async ()=>{
    try{
      const response=await axios.get('mern-challenges-mqhi.vercel.app/api/myCounter');
  ...
  const incrementCounter = useCallback(async () => {
    try {
      await axios.post('mern-challenges-mqhi.vercel.app/api/mycounter/increment');
  ...
  const decrementCounter = useCallback(async () => {
    try {
      await axios.post('mern-challenges-mqhi.vercel.app/api/mycounter/decrement');
...
const Counter = () => {
  ...
  const fetchCounter = useCallback(async () => {
    try {
      const response = await axios.get('mern-challenges-mqhi.vercel.app/api/counter');
  ...
  const incrementCounter = useCallback(async () => {
    try {
      await axios.post('mern-challenges-mqhi.vercel.app/api/counter/increment');
  ...
  const decrementCounter = useCallback(async () => {
    try {
      await axios.post('mern-challenges-mqhi.vercel.app/api/counter/decrement');
